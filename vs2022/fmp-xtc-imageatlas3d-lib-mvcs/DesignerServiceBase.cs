...
namespace XTC.FMP.MOD.ImageAtlas3D.LIB.MVCS
{
    ...
    public class DesignerServiceBase : Service
    {
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallReadStyleSheet(ScopeRequest? _request, SynchronizationContext? _context)
        {
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallWriteStyle(DesignerWriteStylesRequest? _request, SynchronizationContext? _context)
        {
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallReadInstances(ScopeRequest? _request, SynchronizationContext? _context)
        {
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallWriteInstances(DesignerWriteInstancesRequest? _request, SynchronizationContext? _context)
        {
