...
using XTC.FMP.MOD.ImageAtlas3D.App.Web;
...
public partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        permissioS[Permissions.DesignerCreate] = "";
        permissioS[Permissions.DesignerUpdate] = "";
        permissioS[Permissions.DesignerRetrieve] = "";
        permissioS[Permissions.DesignerDelete] = "";
        ...
        framework.setUserData("XTC.FMP.MOD.ImageAtlas3D.LIB.MVCS.Entry", entry);
